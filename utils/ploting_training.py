...
def argsOptions():
    ...
    parser.add_argument('-eps', action='store_true', help='If enabled, saves the figuras as an EPS file. By default it is saved as a pdf')
...
def plotJSON(args):
    ...
    save_folder = os.path.join(ROOT_DIR, args.OutputPath)
    ...
    axs[1].set_ylabel('Fidelity loss\n'+ r"($\ell_2$)")
    ...
    axs[2].set_ylabel('Sparsity loss\n'+ r"($\ell_1$)")
